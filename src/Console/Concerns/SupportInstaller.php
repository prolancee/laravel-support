...
trait SupportInstaller
{
    ...
    protected function initPaths($helper_path = null): void
    {
        $this->paths = [
            'helper'   => $helper_path,
    ...
    {
        $this->copyFile(
            __DIR__.'/../../App/Notifier/Notifier.php',
    ...
    protected function ensureViewFolderExists(): string
    {
        return tap(resource_path('views/prolancee'), function ($path) {
            if (!File::exists($path)) {
                File::makeDirectory($path, 0755, true);
            }
        });
